...
def hesapla():
    ...
    giris.delete(0,'end')
    giris.insert(0,int(sonuc)) if (sonuc*10)%10==0 else giris.insert(0,str(sonuc))
...
eb=Button(text='=',font="Verdana 14 bold",width=2,fg="RED",command=hesapla)
eb.place(x=120,y=200)

c=Button(text='C',font="Verdana 14 bold",width=2,fg="NAVYBLUE",command=sil)
c.place(x=20,y=250)
